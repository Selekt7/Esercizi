...
//     */
    ...
    private final static int MAX_WEEK_IN_A_YEAR=52;
    private final static int MAX_DAYS_IN_A_WEEK=7;
    private final static int MAX_HOURS_IN_A_DAY=24;
    public static void exercise4() {
        System.out.println("\nExercise 4:");
        for (int week = 0; week < MAX_WEEK_IN_A_YEAR; week++) {
