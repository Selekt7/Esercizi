...
public class Main {
    ...
    private static void exercise1() {
        ...
        int myNumbInteger= Integer.valueOf(ourNumberStr);
        myNumbInteger += 2;
        System.out.println(myNumbInteger);
        String myNumbIntegerAsString= String.valueOf(myNumbInteger);
        System.out.println(myNumbIntegerAsString);
        System.out.println(myNumbIntegerAsString + 2);
    ...
    private static void exercise2() {
        ...
        System.out.println("Make this print 'w' -> current result: '" + anotherString.charAt(3) + "'");
    }
    ...
    private static void exercise4() {
        ...
        ourNumber *=2;
        startStr = String.valueOf(ourNumber);
        startStr= startStr + startStr;
        double doubleNum= Double.valueOf(startStr);
        doubleNum /= 3.5;
