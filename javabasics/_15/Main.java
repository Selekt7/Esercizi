    ...
    private static void exercise2() {
        ...
        while (remainingPoundsToSell > 0) {
            ...
            if (poundToEuroExchangeRate >= 1.15) {
                ...
                System.out.println("In day " + daysToSell + ", the exchange rate is : " + Math.round(poundToEuroExchangeRate * 100.0) / 100.0 + ", so I SELL and now I have " + remainingPoundsToSell);
            } else {
                System.out.println("In day " + daysToSell + ", the exchange rate is : " + Math.round(poundToEuroExchangeRate * 100.0) / 100.0 + " so I DIDN'T SELL");
            }
